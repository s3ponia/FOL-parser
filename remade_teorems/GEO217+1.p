...
? vX . ? vY . ( ( pdistinct_points(vX,vY) -> ~papart_point_and_line(vX,fline_connecting(vX,vY)) ) )
? vX . ? vY . ( ( pdistinct_points(vX,vY) -> ~papart_point_and_line(vY,fline_connecting(vX,vY)) ) )
? vX . ? vY . ( ( pconvergent_lines(vX,vY) -> ~papart_point_and_line(fintersection_point(vX,vY),vX) ) ) 
? vX . ? vY . ( ( pconvergent_lines(vX,vY) -> ~papart_point_and_line(fintersection_point(vX,vY),vY) ) )
...
? vX . ? vY . ? vZ . ( ( pconvergent_lines(vX,vY) -> ( pdistinct_lines(vY,vZ) or pconvergent_lines(vX,vZ) ) ) ) 
...
? vL . ? vM . ? vN . ( ( ( ~pconvergent_lines(vL,vM) and ~pconvergent_lines(vL,vN) ) -> ~pconvergent_lines(vM,vN) ) )
